  ...
  \tl_case:Nn #3
  {
    ...
    \l__svg_action_m_tl
    {
      \draw_path_moveto:n {
        ...
        \tl_item:Nn #1 {2} + \seq_item:Nn #4 {2}
      }
      \tl_set:Nx #1 {
        {\fp_eval:n {\tl_item:Nn #1 {1} + \seq_item:Nn #4 {1}}}
        {\fp_eval:n {\tl_item:Nn #1 {2} + \seq_item:Nn #4 {2}}}
      }
      \tl_set_eq:NN #2 #1
      \int_set:Nn \l__svg_points_int {2}
    }
    ...
    \l__svg_action_v_tl
    {
      \draw_path_lineto:n {
        \tl_item:Nn #1 {1},
        \tl_item:Nn #1 {2} + \seq_item:Nn #4 {1}
      }
      \tl_set:Nx #1 {
        {\tl_item:Nn #1 {1}}
        {\fp_eval:n {\tl_item:Nn #1 {2} + \seq_item:Nn #4 {1}}}
      }
      \tl_set_eq:NN #2 #1
      \int_set:Nn \l__svg_points_int {1}
    }
    ...
    \l__svg_action_Q_tl
    {
      ...
      \tl_set:Nx #2 {
        {2*(\seq_item:Nn #4 {3}) - \seq_item:Nn #4 {1}}
        {2*(\seq_item:Nn #4 {4}) - \seq_item:Nn #4 {2}}
      }
      \tl_set:Nx #1 {
        {\seq_item:Nn #4 {3}}
        {\seq_item:Nn #4 {4}}
    ...
    \l__svg_action_q_tl
    {
      ...
      }
      {
        ...
        \tl_item:Nn #1 {2} + \seq_item:Nn #4 {4}
      }
      \tl_set:Nx #2 {
        {\fp_eval:n {\tl_item:Nn #1 {1} + 2*(\seq_item:Nn #4 {3}) - \seq_item:Nn #4 {1} }}
        {\fp_eval:n {\tl_item:Nn #1 {2} + 2*(\seq_item:Nn #4 {4}) - \seq_item:Nn #4 {2} }}
      }
      \tl_set:Nx #1 {
        {\fp_eval:n {\tl_item:Nn #1 {1} + \seq_item:Nn #4 {3}}}
        {\fp_eval:n {\tl_item:Nn #1 {2} + \seq_item:Nn #4 {4}}}
      }
      \int_set:Nn \l__svg_points_int {4}
    }
    \l__svg_action_C_tl
    {
      ...
      \tl_set:Nx #2 {
        {2*(\seq_item:Nn #4 {5}) - (\seq_item:Nn #4 {3})}
        {2*(\seq_item:Nn #4 {6}) - (\seq_item:Nn #4 {4})}
      }
      \tl_set:Nx #1 {
        {\seq_item:Nn #4 {5}}
        {\seq_item:Nn #4 {6}}
    ...
    \l__svg_action_c_tl
    {
      ...
      }
      {
        ...
        \tl_item:Nn #1 {2} + \seq_item:Nn #4 {6}
      }
      \tl_set:Nx #2 {
        {\fp_eval:n {\tl_item:Nn #1 {1} + 2*(\seq_item:Nn #4 {5}) - \seq_item:Nn #4 {3} }}
        {\fp_eval:n {\tl_item:Nn #1 {2} + 2*(\seq_item:Nn #4 {6}) - \seq_item:Nn #4 {4} }}
      }
      \tl_set:Nx #1 {
        {\fp_eval:n {\tl_item:Nn #1 {1} + \seq_item:Nn #4 {5}}}
        {\fp_eval:n {\tl_item:Nn #1 {2} + \seq_item:Nn #4 {6}}}
      }
      \int_set:Nn \l__svg_points_int {6}
    }
    \l__svg_action_T_tl
    {
      ...
      \tl_set:Nx #2 {
        ...
        {\fp_eval:n {2*(\seq_item:Nn #4 {2}) - \tl_item:Nn #2 {2}} }
      }
      \tl_set:Nx #1 {
        {\seq_item:Nn #4 {1}}
        {\seq_item:Nn #4 {2}}
    ...
    \l__svg_action_t_tl
    {
      ...
      \tl_set:Nx #2 {
        ...
        {\fp_eval:n {2 * (\tl_item:Nn #1 {2} + \seq_item:Nn #4 {2}) - \tl_item:Nn #2 {2}} }
      }
      \tl_set:Nx #1 {
        {\fp_eval:n {\tl_item:Nn #1 {1} +\seq_item:Nn #4 {1}}}
        {\fp_eval:n {\tl_item:Nn #1 {2} +\seq_item:Nn #4 {2}}}
    ...
    \l__svg_action_S_tl
    {
      ...
      \tl_set:Nx #2 {
        ...
        {\fp_eval:n {2*(\seq_item:Nn #4 {4}) - \seq_item:Nn #4 {2}} }
      }
      \tl_set:Nx #1 {
        {\seq_item:Nn #4 {3}}
        {\seq_item:Nn #4 {4}}
